...
export default function AdminProductEdit({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (loading) {
    return <div className="container section"><h2>Loading product details...</h2></div>;
  }
      ...
      <div className="admin-card" style={{ padding: "2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1.5rem", marginTop: "1.5rem" }}>
          ...
          <div className="form-group">
            ...
            <input id="salePrice" type="number" step="0.01" value={formData.salePrice} onChange={handleChange} />
          </div>
          <div className="form-group">
